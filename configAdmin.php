    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">DC Electronics</small></h1>
            </div>
            <!-- Nav tabs -->
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="add-provee">
                            ...
                            <form action="process/regprove.php" method="post" role="form">
                                <div class="form-group">
                                    <label>Codigo</label>
                                    <input class="form-control" type="text" name="prove-nit" placeholder="Cod proveedor" maxlength="30" required="">
                                </div>
                                <div class="form-group">
                                    <label>Nombre</label>
